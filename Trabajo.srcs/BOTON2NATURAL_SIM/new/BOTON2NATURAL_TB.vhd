...
begin
    ...
    begin
        ...
        for i in BOT_IN'reverse_range loop
            --hace cada prueba j en un piso i
        ...
        --prueba pulsar los botones en escala ascendente 

        for i in BOT_IN'reverse_range loop
            wait for CLK_PERIOD;
            BOT_IN(i) <= '1';
            wait for 100*CLK_PERIOD + CLK_PERIOD*N_CICLOS;
        ...
        --prueba a pulsar los botones en orden descendente
